...
\usetikzlibrary{patterns,positioning,fit,backgrounds,arrows.meta,calc}
...
\NKTsetup{%
  论文题目(中文) = 面向指数增强策略的量化算法优化设计与实现,
  %论文题目(中文)(第二行) =第二行中文题目，填无则不显示本行,
  论文题目(中文)(第二行) = 无,
  论文题目(英文) =  {Optimized Design and Implementation of Quantitative},
  论文题目(英文)(第二行) ={Algorithms for Index Enhancement Strategies},
  % 论文题目(英文)(第二行) =无,
  学号           = 2210556,
  姓名          = 廖望,
  年级          = 2022,
