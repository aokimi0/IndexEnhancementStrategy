...
\NKTsetup{%
  论文题目(中文) = 沪深300指数增强策略的量化算法优化设计与实现,
  %论文题目(中文)(第二行) =第二行中文题目，填无则不显示本行,
  论文题目(中文)(第二行) = A股非有效市场特征下的轻量级机器学习研究,
  论文题目(英文) =  {Optimized Design and Implementation of Quantitative Algorithms for CSI 300 Index Enhancement Strategy},
  论文题目(英文)(第二行) = {A Lightweight Machine Learning Study under Inefficient A-Share Market Characteristics},
  % 论文题目(英文)(第二行) =无,
  学号           = 2210556,
  姓名          = 廖望,
  年级          = 2022,
